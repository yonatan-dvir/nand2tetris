public class Code {
    ...
    public static String dest(String destString){
        ...
        throw new IllegalStateException("Unknown dest string: " + destString.trim());
    }
    ...
    public static String comp(String compString){
        ...
        throw new IllegalStateException("Unknown comp string");
    }
    ...
    public static String jump(String jumpString){
        ...
        throw new IllegalStateException("Unknown jump string");
    }
}
